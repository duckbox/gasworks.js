...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['underscore', 'jquery', 'exports'], function(_, $, exports) {
      root.Backbone = root.GasWorks = factory(root, exports, _, $);
    });
    ...
    root.Backbone = root.GasWorks = factory(root, {}, root._, (root.jQuery || root.Zepto || root.ender || root.$));
  }
...
Backbone.Renderer = Object.create(fastdom);
...
var viewOptions = ['model', 'collection', 'el', 'id', 'attributes', 'className', 'tagName', 'events', 'params'];
...
var View = Backbone.View = function(options) {
  ...
  this.templateContext = this.template;
  this._handlers = [];
  this._ensureElement();
  this.initialize.apply(this, arguments);
  this.delegateEvents();
...
_.extend(View.prototype, Events, {
  ...
  render: function() {
    ...
    Backbone.Renderer.write(function() {
      ...
      this.el.innerHTML = this.templateContext({
        "foos": "stuff"
      });
...
_.extend(Router.prototype, Events, {
  ...
  route: function(route, name, callback) {
    ...
    if( typeof callback === 'object' ) {
      ...
      if( callback.view ) {
        view = this._makeViewCallback( callback.view, params );
      }
  ...
  _makeViewCallback : function( view, params ) {      
    ...
    return function(){
      ...
      this.currentView = new view({ params : paramList });
